...
const es: TranslationMap = {
  ...
  'language.sheet_note': 'Las marcas como La Casa del Pollazo, Pollazo Plus y Pollazo Galapagueño se mantienen iguales. Los textos de la app se traducen según el idioma elegido.',
...
const en: TranslationMap = { ...es,
  ...
  'language.saved': 'Language updated', 'language.card_kicker': 'Language', 'language.card_title': 'App language', 'language.card_text': 'Switch the app to your preferred language. Ideal for local customers and tourists in Galápagos.', 'language.current_label': 'Current language', 'language.change_button': 'Change language', 'language.sheet_title': 'Choose your language', 'language.sheet_subtitle': 'The app will remember your choice for future visits.', 'language.sheet_note': 'Brand names like La Casa del Pollazo, Pollazo Plus and Pollazo Galapagueño stay unchanged. App texts are translated according to your selected language.', 'language.quick_change_name': 'Change language', 'language.select_aria': 'Select language {language}',
  'info.hero.kicker': 'Official information', 'info.location.saved': 'Saved location', 'info.level.sheet_kicker': 'Pollazo levels', 'info.level.sheet_title': 'How to level up', 'info.level.sheet_text': 'Your level grows with valid purchase history. It helps understand your progress and prepare future benefits.', 'info.level.max_reached': 'You reached the highest level.', 'info.level.remaining': 'You need {points} progress points to level up.', 'info.level.from_to': 'From {min} pts to {max} pts.', 'info.level.from_plus': 'From {min} pts and up.', 'info.level.label': 'Level {level} · {title}',
  'info.account.title': 'My Pollazo account', 'info.account.subtitle': 'Customer level and profile', 'info.account.empty': 'Register your name, WhatsApp and location to activate your profile, save addresses and level up.', 'info.account.level_progress': 'Level progress', 'info.account.plus_active': 'Pollazo Plus active · ', 'info.account.default_name': 'Pollazo Customer',
  ...
  'info.notifications.not_available': 'Not available', 'info.notifications.need_phone': 'First register your WhatsApp to link alerts to your order.', 'info.notifications.manual_blocked': 'Alerts are blocked. You must allow them manually from phone or browser settings.', 'info.notifications.ready_notice': 'Done. We will notify you about orders, Plus and important updates.', 'info.notifications.repaired_notice': 'Alerts repaired. This phone was registered again.', 'info.notifications.active': 'Active', 'info.notifications.blocked': 'Blocked', 'info.notifications.recommended': 'Recommended', 'info.notifications.register_data': 'Register data', 'info.notifications.allow_help': 'How to allow', 'info.notifications.repairing': 'Repairing...', 'info.notifications.activating': 'Activating...', 'info.notifications.active_button': 'Alerts active', 'info.notifications.activate': 'Activate alerts', 'info.notifications.kicker': 'Important alerts', 'info.notifications.title': 'Pollazo notifications', 'info.notifications.text': 'We will notify you about order status, Plus gifts, important changes and useful reminders. No spam.', 'info.notifications.blocked_message': 'Your phone or browser blocked alerts. For security, permission must be changed manually from settings.', 'info.notifications.active_message': 'Alerts active. Your phone is ready to receive Pollazo notifications.',
  'info.install.title': 'Install app', 'info.install.subtitle': 'Fast access from your phone.', 'info.contact.title': 'Direct contact', 'info.contact.whatsapp': 'Official WhatsApp', 'info.contact.attention': 'Immediate support', 'info.contact.chat': 'Chat', 'info.contact.phone': 'Phone line', 'info.contact.call': 'Call', 'info.hours.title': 'Opening hours', 'info.hours.value': '7:00 AM – 9:00 PM · Every day', 'info.location.title': 'Location', 'info.buy.title': 'Order now', 'info.buy.subtitle': 'View catalog and build your order', 'info.team.title': 'Our Team', 'info.team.subtitle': 'People behind service and support', 'info.gallery.title': 'Gallery', 'info.legal.title': 'Legal information and help', 'info.legal.subtitle': 'Terms, privacy, payments, deliveries and support', 'info.legal.note': 'Rewards, levels, promotions and benefits may change depending on what the business activates. The app will always show what is available.', 'info.footer': 'Made for easy shopping in Puerto Ayora',
  'legal.required.title': 'Before continuing', 'legal.required.subtitle': 'Review and accept to use the app', 'legal.required.notice': 'To order, save your location, receive order alerts and use benefits, you need to accept these basic rules.', 'legal.read.title': 'Legal center and help', 'legal.read.subtitle': 'Check rules, privacy and support', 'legal.hero.title': 'Easy ordering, clear rules', 'legal.hero.text': 'Here we explain how orders, payments, deliveries, personal data, benefits, points, notifications and help work.', 'legal.category.orders': 'Orders', 'legal.category.orders_text': 'Status, changes and confirmation.', 'legal.category.payments': 'Payments', 'legal.category.payments_text': 'Cash, Deuna, transfer and card.', 'legal.category.data': 'Data', 'legal.category.data_text': 'Privacy, location and security.', 'legal.info_title': 'Legal information', 'legal.help_title': 'Quick help', 'legal.help.order': 'Problems with my order', 'legal.help.order_text': 'Check status, changes, cancellations, missing products or delivery coordination.', 'legal.help.payment': 'Payment problems', 'legal.help.payment_text': 'Help with receipts, Deuna, transfers, rejected payments or pending payments.', 'legal.help.location': 'Location or delivery', 'legal.help.location_text': 'Correct delivery reference, Airbnb, hotel, home or nearby business.', 'legal.help.notifications': 'Notifications and tracking', 'legal.help.notifications_text': 'Review order alerts, phone permissions and live tracking.', 'legal.help.security': 'Account security', 'legal.help.security_text': 'Report suspicious activity, wrong number or verification problems.', 'legal.help.data': 'My data', 'legal.help.data_text': 'Request to update, correct or delete data linked to your WhatsApp.', 'legal.whatsapp': 'Contact by WhatsApp', 'legal.update_note': 'These terms may be updated when features, payment methods, promotions, delivery, memberships or business requirements change.', 'legal.footer_required': 'By continuing you confirm that you understand the rules for use, ordering, delivery, payments and privacy.', 'legal.footer_read': 'This section is for review only. You already accepted the rules when entering for the first time.', 'legal.accept': 'Accept and continue', 'legal.close_reading': 'Close reading',
};

const pt: TranslationMap = { ...en, 'common.close': 'Fechar', 'common.current': 'Atual', 'nav.home': 'Início', 'nav.catalog': 'Catálogo', 'nav.orders': 'Pedidos', 'nav.cart': 'Carrinho', 'header.orders': 'Meus pedidos', 'header.info': 'Informação', 'header.back_home': 'Início', 'language.card_title': 'Idioma do app', 'language.change_button': 'Alterar idioma', 'language.sheet_title': 'Escolha seu idioma', 'language.quick_change_name': 'Alterar idioma', 'info.account.title': 'Minha conta Pollazo', 'info.delivery.title': 'Minha entrega', 'info.buy.title': 'Comprar agora', 'info.legal.title': 'Informação legal e ajuda', 'legal.accept': 'Aceitar e continuar' };
const fr: TranslationMap = { ...en, 'common.close': 'Fermer', 'common.current': 'Actuel', 'nav.home': 'Accueil', 'nav.catalog': 'Catalogue', 'nav.orders': 'Commandes', 'nav.cart': 'Panier', 'header.orders': 'Mes commandes', 'header.info': 'Information', 'header.back_home': 'Accueil', 'language.card_title': 'Langue de l’app', 'language.change_button': 'Changer de langue', 'language.sheet_title': 'Choisissez votre langue', 'language.quick_change_name': 'Changer de langue', 'info.account.title': 'Mon compte Pollazo', 'info.delivery.title': 'Ma livraison', 'info.buy.title': 'Commander maintenant', 'info.legal.title': 'Informations légales et aide', 'legal.accept': 'Accepter et continuer' };
const de: TranslationMap = { ...en, 'common.close': 'Schließen', 'common.current': 'Aktuell', 'nav.home': 'Start', 'nav.catalog': 'Katalog', 'nav.orders': 'Bestellungen', 'nav.cart': 'Warenkorb', 'header.orders': 'Meine Bestellungen', 'header.info': 'Information', 'header.back_home': 'Start', 'language.card_title': 'App-Sprache', 'language.change_button': 'Sprache ändern', 'language.sheet_title': 'Sprache wählen', 'language.quick_change_name': 'Sprache ändern', 'info.account.title': 'Mein Pollazo-Konto', 'info.delivery.title': 'Meine Lieferung', 'info.buy.title': 'Jetzt bestellen', 'info.legal.title': 'Rechtliche Informationen und Hilfe', 'legal.accept': 'Akzeptieren und fortfahren' };
const it: TranslationMap = { ...en, 'common.close': 'Chiudi', 'common.current': 'Attuale', 'nav.catalog': 'Catalogo', 'nav.orders': 'Ordini', 'nav.cart': 'Carrello', 'header.orders': 'I miei ordini', 'header.info': 'Informazioni', 'language.card_title': 'Lingua dell’app', 'language.change_button': 'Cambia lingua', 'language.sheet_title': 'Scegli la lingua', 'language.quick_change_name': 'Cambia lingua', 'info.account.title': 'Il mio account Pollazo', 'info.delivery.title': 'La mia consegna', 'info.buy.title': 'Ordina ora', 'info.legal.title': 'Informazioni legali e aiuto', 'legal.accept': 'Accetta e continua' };
const zh: TranslationMap = { ...en, 'common.close': '关闭', 'common.current': '当前', 'common.ready': '已准备', 'common.pending': '待处理', 'common.use': '使用', 'common.edit': '编辑', 'common.repair': '修复', 'common.help': '帮助', 'common.understood': '明白', 'nav.home': '首页', 'nav.catalog': '目录', 'nav.orders': '订单', 'nav.cart': '购物车', 'nav.info': '信息', 'header.catalog': '目录', 'header.orders': '我的订单', 'header.cart': '购物车', 'header.info': '信息', 'header.ranking': 'VIP 排行榜', 'header.home_subtitle': '市场第一', 'header.back_home': '首页', 'header.open_ranking': '打开排行榜', 'header.open_profile': '打开个人资料', 'header.open_cart': '打开购物车', 'language.saved': '语言已更新', 'language.card_kicker': '语言', 'language.card_title': '应用语言', 'language.card_text': '将应用切换到你喜欢的语言。适合本地顾客和加拉帕戈斯游客。', 'language.current_label': '当前语言', 'language.change_button': '更改语言', 'language.sheet_title': '选择语言', 'language.sheet_subtitle': '应用会记住你的选择。', 'language.quick_change_name': '更改语言', 'language.select_aria': '选择语言 {language}', 'info.hero.kicker': '官方信息', 'info.account.title': '我的 Pollazo 账户', 'info.account.subtitle': '客户等级和资料', 'info.account.level_progress': '等级进度', 'info.delivery.title': '我的配送', 'info.delivery.add_point': '添加配送地点', 'info.delivery.selected': '已选择', 'info.delivery.add_new': '添加新地址', 'info.notifications.title': 'Pollazo 通知', 'info.notifications.activate': '开启通知', 'info.notifications.active_button': '通知已开启', 'info.contact.title': '直接联系', 'info.contact.chat': '聊天', 'info.contact.call': '拨打', 'info.hours.title': '营业时间', 'info.location.title': '位置', 'info.buy.title': '立即下单', 'info.buy.subtitle': '查看目录并创建订单', 'info.team.title': '我们的团队', 'info.gallery.title': '图库', 'info.legal.title': '法律信息和帮助', 'info.footer': '为 Puerto Ayora 轻松购物而做', 'legal.required.title': '继续之前', 'legal.read.title': '法律中心和帮助', 'legal.accept': '接受并继续', 'legal.close_reading': '关闭', 'legal.hero.title': '轻松下单，规则清晰', 'legal.whatsapp': '通过 WhatsApp 联系' };
const ja: TranslationMap = { ...en, 'common.close': '閉じる', 'common.current': '現在', 'nav.home': 'ホーム', 'nav.catalog': 'カタログ', 'nav.orders': '注文', 'nav.cart': 'カート', 'nav.info': '情報', 'header.info': '情報', 'header.back_home': 'ホーム', 'language.card_title': 'アプリの言語', 'language.change_button': '言語を変更', 'language.sheet_title': '言語を選択', 'language.quick_change_name': '言語を変更', 'info.account.title': 'Pollazo アカウント', 'info.delivery.title': '配送先', 'info.buy.title': '今すぐ注文', 'info.legal.title': '法的情報とヘルプ', 'legal.accept': '同意して続行' };
const nl: TranslationMap = { ...en, 'common.close': 'Sluiten', 'common.current': 'Huidig', 'nav.catalog': 'Catalogus', 'nav.orders': 'Bestellingen', 'nav.cart': 'Winkelwagen', 'header.orders': 'Mijn bestellingen', 'header.info': 'Informatie', 'language.card_title': 'App-taal', 'language.change_button': 'Taal wijzigen', 'language.sheet_title': 'Kies je taal', 'language.quick_change_name': 'Taal wijzigen', 'info.account.title': 'Mijn Pollazo-account', 'info.delivery.title': 'Mijn bezorging', 'info.buy.title': 'Nu bestellen', 'info.legal.title': 'Juridische informatie en hulp', 'legal.accept': 'Accepteren en doorgaan' };
const ru: TranslationMap = { ...en, 'common.close': 'Закрыть', 'common.current': 'Текущий', 'nav.home': 'Главная', 'nav.catalog': 'Каталог', 'nav.orders': 'Заказы', 'nav.cart': 'Корзина', 'nav.info': 'Инфо', 'header.orders': 'Мои заказы', 'header.info': 'Информация', 'header.back_home': 'Главная', 'language.card_title': 'Язык приложения', 'language.change_button': 'Изменить язык', 'language.sheet_title': 'Выберите язык', 'language.quick_change_name': 'Изменить язык', 'info.account.title': 'Мой аккаунт Pollazo', 'info.delivery.title': 'Моя доставка', 'info.buy.title': 'Заказать сейчас', 'info.legal.title': 'Правовая информация и помощь', 'legal.accept': 'Принять и продолжить' };
