...
import { Camera, User, Phone, X, Sparkles, Check } from 'lucide-react';
...
export default function LoginModal({
  ...
  // 🔥 ESTRATEGIA DE PRE-CARGA PARA GALÁPAGOS 🔥
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white/95 backdrop-blur-md rounded-[50px] shadow-[0_20px_100px_-20px_rgba(0,0,0,0.3)] border border-white flex flex-col max-h-[92vh] animate-in fade-in zoom-in-95 duration-300 overflow-hidden">
        ...
        <div className="p-6 pb-2 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left leading-tight">
              <h2 className="text-xl font-black text-slate-900 uppercase italic tracking-tighter leading-none">Únete al Club</h2>
              <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1">REGÍSTRATE Y GANA PUNTOS PARA PREMIOS 🍗</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto hide-scrollbar p-6 pt-2 space-y-5">
          ...
          {/* SECCIÓN AVATARES (MOSTRANDO TODOS POR DEFECTO) */}
        ...
        <div className="p-6 pt-2 bg-white flex-shrink-0 border-t border-slate-50">
          ...
          <button onClick={handleSave} className="w-full rounded-3xl bg-gradient-to-r from-orange-500 to-orange-600 h-16 text-[12px] font-black text-white shadow-xl shadow-orange-500/40 active:scale-95 uppercase tracking-widest transition-all border-b-4 border-orange-700">
