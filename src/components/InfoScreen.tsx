import { Info, MapPin, Clock, ShieldCheck, ShoppingBag } from 'lucide-react';
    ...
    <div className="p-6 bg-gray-50 min-h-screen pb-24">
      ...
      <div className="grid gap-4">
        <div className="bg-white p-6 rounded-[28px] flex items-center gap-5 border border-gray-100 shadow-sm">
          <div className="w-12 h-12 bg-blue-50 text-blue-500 rounded-2xl flex items-center justify-center flex-shrink-0"><MapPin size={24} /></div>
          <div>
        ...
        <div className="bg-white p-6 rounded-[28px] flex items-center gap-5 border border-gray-100 shadow-sm">
          <div className="w-12 h-12 bg-green-50 text-green-500 rounded-2xl flex items-center justify-center flex-shrink-0"><Clock size={24} /></div>
          <div>
        ...
        <div className="bg-white p-6 rounded-[28px] flex items-center gap-5 border border-gray-100 shadow-sm">
          <div className="w-12 h-12 bg-orange-50 text-orange-500 rounded-2xl flex items-center justify-center flex-shrink-0"><ShieldCheck size={24} /></div>
          <div>
        ...
        <div className="bg-white p-6 rounded-[28px] flex items-center gap-5 border border-gray-100 shadow-sm">
          <div className="w-12 h-12 bg-purple-50 text-purple-500 rounded-2xl flex items-center justify-center flex-shrink-0"><ShoppingBag size={24} /></div>
          <div>
      ...
      <div className="mt-12 text-center space-y-2">
        ...
        <p className="text-[9px] text-gray-400 font-bold uppercase italic">Puerto Ayora - Galápagos</p>
      </div>
    </div>
  );
}
