...
import { Package, Truck, CheckCircle2, ClipboardList, ChevronUp, ChevronDown, X, ShoppingBag } from 'lucide-react';
...
const statusSteps: Array<{ status: OrderStatus; label: string; icon: any }> = [
  ...
  { status: 'Preparando', label: 'Empacando', icon: ShoppingBag }, // Cambio a tienda
