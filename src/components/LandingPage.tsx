...
export default function LandingPage({
  ...
  const installReady = Boolean(deferredPrompt || canInstall || isIOS());

  return (
    <div
      className="min-h-screen bg-white text-gray-950 overflow-x-hidden font-sans"
    ...
    >
      ...
      {!isStandalone && (
        <section className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center px-6 py-16 text-center bg-gradient-to-b from-orange-500 via-orange-400 to-orange-300">
          ...
          <div className="relative z-10 max-w-md mx-auto space-y-10 opacity-100 transition-opacity duration-700">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/90 text-[15px] font-semibold leading-relaxed max-w-xs mx-auto tracking-wide">
                Tu market de confianza con pollo fresco enfundado y productos
            ...
            <div className="w-full max-w-xs mx-auto space-y-4">
              ...
              >
                ...
                {installReady ? 'Instalar en mi Celular' : 'Preparando Instalación...'}
              </button>
      ...
      <main className="px-5 py-10 space-y-16 bg-gradient-to-b from-white via-orange-50/40 to-white">
        <section className="min-h-screen flex items-center rounded-[42px] p-8 text-white shadow-2xl relative overflow-hidden bg-orange-500">
        ...
        <section className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-[30px] p-5 shadow-sm border border-orange-100">
        ...
        <section className="space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2 row-span-2 rounded-[32px] overflow-hidden h-60 shadow-xl hover:scale-[1.01] active:scale-[0.98] transition-transform duration-300">
              <img
            ...
            <div className="rounded-[28px] overflow-hidden h-[114px] shadow-md hover:scale-[1.02] active:scale-[0.98] transition-transform duration-300">
              <img
